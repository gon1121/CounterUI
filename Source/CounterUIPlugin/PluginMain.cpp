...
//============================================================================================================
class CounterUIPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "CounterUIPlugin";  // must match DLL name
  }
};

//  global plugin instance
CounterUIPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_CounterUIPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_CounterUIPlugin();}
...
void CounterUIPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("CounterUIPluginClass:OnInitEnginePlugin()");
...
void CounterUIPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("CounterUIPluginClass:OnDeInitEnginePlugin()");
